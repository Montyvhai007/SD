...
// Fundraiser Routes
Route::get('/fundraiser/list', [FundraiserController::class, 'showFundList'])->middleware('auth')->name('fundraiser.list');

// Donor Routes
Route::get('/donor/donate', [DonorController::class, 'showDonationPage'])->middleware('auth')->name('donor.donate');
